(function($ ){
	...
	handleClick = function( element_id ) {
		if ( 'add-wsublock-single' === element_id ) {
			updateBoxCount();
			$('#wsublock-wrapper' ).append('<div id="wsublock-current-' + tiny_instance_count + '" class="wsublock-current-container"></div>');
			...
			$('#wsublock-wrapper' ).append('<input type="hidden" name="wsublock-type-' + tiny_instance_count + '" value="single">');
		}
	};
